...
namespace DiscountPoolBackbone.Controllers
{
    public class ArticlesController : Controller
    {
        ...
        public ArticlesController(DiscountsContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,CreateDate,Header,MainContent,ImageId,Note,IsActual,AreAllPhotoFromFolder,AuthorId,Cost,AdditionalUrl,PublicationDate,LikedClients")] Article article)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CreateDate,Header,MainContent,ImageId,Note,IsActual,AreAllPhotoFromFolder,AuthorId,Cost,AdditionalUrl,PublicationDate,LikedClients")] Article article)
        {
            if (id != article.Id)
            {
                return NotFound();
